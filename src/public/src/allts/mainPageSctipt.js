...
// 主页轮播图相关内容
var mainPageRoundImg = document.getElementById('mainPageRoundImg');
var mainRoundBox = document.getElementById('mainRoundBox');
var imgArr = [
...
window.addEventListener('load', function () {
    var images = document.querySelectorAll('.card-img, .person-img');
